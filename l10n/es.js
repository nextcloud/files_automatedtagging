OC.L10N.register(
    ...
    "No tags given" : "No se han otorgado etiquetas",
    "Tag(s) could not be found: %s" : "No se pudo encontrar esta(s) etiqueta(s): %s",
    ...
    "Automatically tag files based on factors such as filetype, user group memberships, time and more." : "Etiqutar automáticamente los archivos basándose en factores como el tipo de archivo, la pertenencia a grupos de usuarios, el tiempo y más.",
