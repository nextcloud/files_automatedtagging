OC.L10N.register(
    ...
    "Each rule group consists of one or more rules. A request matches a group if all rules evaluate to true. On uploading a file all defined groups are evaluated and when matching, the given collaborative tags are assigned to the file." : "Chaque groupe de règles est constitué d’une ou plusieurs règles. Une requête correspondra a un groupe si toutes les règles sont validées. Lors du téléversement d’un fichier, tous les groupes définis sont évalués et lorsqu’une correspondance est trouvée, les étiquettes collaboratives sont assignées au fichier.",
