OC.L10N.register(
    ...
    {
    "Tags to assign…" : "Etichette da assegnare...",
    ...
    "An app for Nextcloud that automatically assigns tags to newly uploaded files based on some conditions.\n\nThe tags can later be used to control retention, file access, automatic script execution and more.\n\n![screenshot](docs/screenshot.png)\n\n## How it works\nTo define tags, administrators can create and manage a set of rule groups. Each rule group consists of one or more rules combined through operators. Rules can include criteria like file type, size, time and more. A request matches a group if all rules evaluate to true. On uploading a file all defined groups are evaluated and when matching, the given tags are assigned to the file." : "Un'applicazione per Nextcloud che assegna etichette automaticamente ai file caricati di recente in base a certe condizioni.\n\nLe etichette possono essere utilizzate successivamente per controllare la conservazione, l'accesso ai file, l'esecuzione automatica di script e altro.\n\n![screenshot](docs/screenshot.png)\n\n## Come funziona\nPer definire le etichette, gli amministratori possono creare e gestire un insieme di gruppi di regole. Ogni gruppo di regole consiste di una o più regole combinate tramite operatori. Le regole possono includere criteri come il tipo di file, la dimensione, l'ora e altro. Una richiesta verifica un gruppo se tutte le regole sono valutate come vere. Al caricamento di un file, sono valutati tutti i gruppi definiti e, in caso di corrispondenza, le etichette specifiche sono assegnate al file.",
    "An app for Nextcloud that automatically assigns tags to newly uploaded files based on some conditions" : "Un'applicazione per Nextcloud che assegna automaticamente etichette ai nuovi file caricati sulla base di certe condizioni"
},
